...
interface TextRevealAnimateProps extends Omit<MotionProps, "children"> {
  children: string;
  className?: string;
...
export const TextRevealAnimate = memo(TextRevealAnimateBase);
