# Reference — Hero Liquid Metal Demo

Sumber: code yang dikirim PIC di chat untuk section Home / Hero Banner.

Catatan pemakaian:

- Masuk registry Hero Banner.
- Dipakai sebagai reference component tersedia.
- Untuk Hero Banner final, shader abstract tidak menjadi visual utama kecuali PIC/reviewer meminta.
- Boleh diambil pola composable root/container/content/actions jika cocok.
